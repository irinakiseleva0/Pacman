...
class Wall(Cell):
    ...
    def draw(self) -> None:
        ...
        _draw_rect(px - 12, py - 12, tile + 24, tile + 24, with_alpha(LIVE_CYAN, int(10 + pulse * 10)))
        _draw_rect(px - 7, py - 7, tile + 14, tile + 14, with_alpha(LIVE_PINK, int(8 + pulse * 8)))
        _draw_rect(px - 2, py - 2, tile + 4, tile + 4, with_alpha(LIVE_CYAN, int(30 + pulse * 18)))
        _draw_rect(px + 2, py + 2, tile - 4, tile - 4, with_alpha((6, 8, 22, 255), 226))
