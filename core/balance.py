...
_RUNTIME_FALLBACK = {
    ...
    "rage_duration_tick_step": 20,
    "rage_duration_tick_min": 150,
    "cherry_respawn_tick_step": 8,
    "cherry_respawn_tick_min": 60,
...
_DIFFICULTY_FALLBACK = {
    "Easy": {
        ...
        "ghost_score": 300,
        "summary_lines": [
            "Lives: 5  Rage: forgiving",
            "Ghosts: slower release, longer scatter",
            "Score: generous routes and hunt windows",
        ],
    },
    "Normal": {
        "logic_tick_rate": 3,
        ...
        "ghost_score": 200,
        "summary_lines": [
            "Lives: 3  Rage: readable windows",
            "Ghosts: balanced chase and release",
            "Score: routing and hunt both pay off",
        ],
    },
    "Hard": {
        "logic_tick_rate": 4,
        "rage_duration_ticks": 220,
        "cherry_respawn_ticks": 118,
        "ghost_chase_ticks": 144,
        "ghost_scatter_ticks": 28,
        "ghost_release_tick_interval": 13,
        "initial_lives": 2,
        "seed_score": 8,
        "large_seed_score": 35,
        "cherry_score": 325,
        "ghost_score": 140,
        "summary_lines": [
            "Lives: 2  Rage: short but usable",
            "Ghosts: aggressive pressure, faster release",
            "Score: lower safety, but routes still pay",
        ],
    },
}
